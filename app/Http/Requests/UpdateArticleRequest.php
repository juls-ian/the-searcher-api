...
class UpdateArticleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'thumbnail_same_as_cover' => ['sometimes', 'nullable', 'boolean'],
            // 'thumbnail' => ['sometimes', 'nullable', 'required_without:thumbnail_same_as_cover', 'image', 'mimes:jpg,png,jpeg,webp', 'max:5000'],
            'thumbnail' => ['required_if:thumbnail_same_as_cover,false'],
            'thumbnail_caption' => ['sometimes', 'nullable', 'string'],
            'thumbnail_artist_id' => ['sometimes', 'nullable', 'exists:users,id'],
